                    ...
                    <div class="row">
                        <div class="col-12">
                            <div class="p-2">
                                @if ($partName == 'Part_1')
                                    @if (isset($questions))
                                        <form action="{{ route('updateQuestionListening') }}" method="POST" id="questionForm">
                                            @csrf
                                            @method('PUT')
                                            ...
                                            @for ($i = 11; $i <= 20; $i++)
                                                <div class="form-group mt-3">
                                                    ...
                                                    <input type="text" id="question{{ $i }}"
                                                        name="questions[{{ $i }}][text]" class="form-control mt-2"
                                ...
                                @elseif ($partName == 'Part_3')
                                    @if (isset($questions))
                                        <form action="{{ route('updateQuestionReading') }}" method="POST" id="questionForm">
                                            @csrf
                                            @method('PUT')
                                            <input type="hidden" id="readingId" name="readingId" value="{{ $reading->id }}">
                                            <input type="hidden" id="partName" name="partName" value="{{ $partName }}">
                                            <input type="hidden" id="skillName" name="skillName" value="{{ $skillName }}">
                                            <div class="form-group">
                                    ...
                                    @else
                                        <form action="{{ route('storeQuestionReading') }}" method="POST"
                                            ...
                                            <div class="form-group">
                                                <label for="textareaInput">Passage 3:</label>
                                                <textarea id="textareaInput" name="passage" class="form-control" rows="8" placeholder="Enter text here">{{ old('passage') }}</textarea>
                                            </div>
                                            @for ($i = 21; $i <= 30; $i++)
                                                <div class="form-group mt-3">
                                                    <label for="question{{ $i }}">Question
