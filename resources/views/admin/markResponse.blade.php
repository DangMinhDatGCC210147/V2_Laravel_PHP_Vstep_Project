        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="row">
                    <div class="col-12">
                        <div class="p-2">
                            <form action="{{ route('testResult.update') }}" method="POST" class="needs-validation" novalidate>
                                @csrf
                                    ...
                                    <div class="row p-3">
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.5" min="0" max="10" class="form-control" id="speaking_part1" name="speaking_part1" value="{{ $resultId->speaking_part1 }}" required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid score.
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.5" min="0" max="10" class="form-control" id="speaking_part2" name="speaking_part2" value="{{ $resultId->speaking_part2 }}" required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid score.
                                                </div>
                                            </div>
                                        ...
                                        <div class="col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" step="0.5" min="0" max="10" class="form-control" id="speaking_part3" name="speaking_part3" value="{{ $resultId->speaking_part3 }}" required>
                                                <div class="invalid-feedback">
                                                    Please provide a valid score.
                                                </div>
                                            </div>
